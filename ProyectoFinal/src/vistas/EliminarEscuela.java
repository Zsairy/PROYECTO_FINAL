...
//    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ELIMINAR ESCUELA");
...
//            limpiarContescuelaes();
 ...
 FEscuela fescuela = new FEscuela();
        int confirmacion = JOptionPane.showConfirmDialog(this,
            "¿Quiere eliminar la escuela?", "Confirme",
...
//                    limpiarContescuelaes();
                ...
                JOptionPane.showMessageDialog(this, "Error al eliminar la escuela!!",
                    "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarEscuela().setVisible(true);
            }
        });
    }
    Escuela escuela;
